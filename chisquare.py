...
def plot_antibiotic_resistance(organism):
    ...
    fig.update_layout(
        ...
        yaxis_title='<b>% of S</b>',
        xaxis=dict(tickmode='linear',title_font=dict(size=18,color='black'),tickfont=dict(size=14,color='black')),
        yaxis=dict(
        title=dict(text='<b>% of S</b>', font=dict(size=18, color='black')),  # Bold Y-axis title
        tickfont=dict(size=16, color='black')),
        legend=dict(
        title=dict(text="<b>Antibiotics</b>", font=dict(size=16, color='black')),  # Bold legend title
    ...
    fig1.update_layout(
        ...
        yaxis_title='% of R',
        xaxis=dict(tickmode='linear',title_font=dict(color='black'),tickfont=dict(color='black')),
        legend=dict(
        title=dict(text="<b>Antibiotics</b>", font=dict(size=18, color='black')),  # Bold legend title
...
def conplot_geo(organism):
    ...
    fig.update_layout(
        ...
        title_font=dict(size=18,  # Increase legend title size
            color="black"
        )
    )
    )
